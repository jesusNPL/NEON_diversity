...
## combine spectral and phylogenetic diversity metrics
phylo_spec_NEON_table_SAM_q1 <- full_join(phylo_NEON_table_q1_sel, spec_NEON_div_sel,
                                      by = c("Site", "plotID")
)
...
## combine spectral and phylogenetic diversity metrics
phylo_spec_NEON_table_SAM_q2 <- full_join(phylo_NEON_table_q2_sel, spec_NEON_div_sel,
                                      by = c("Site", "plotID")
)
...
## combine spectral and phylogenetic diversity metrics
phylo_spec_NEON_table_SAM_q3 <- full_join(phylo_NEON_table_q3_sel, spec_NEON_div_sel,
                                      by = c("Site", "plotID")
)

##### Save matched tables #####

save(phylo_spec_NEON_table_SAM_q0, phylo_spec_NEON_table_SAM_q1,
     phylo_spec_NEON_table_SAM_q2, phylo_spec_NEON_table_SAM_q3,
...
## combine spectral and trait diversity metrics
trait_spec_NEON_table_MET_SAM_q0 <- full_join(trait_NEON_table_q0_sel,
                                          spec_NEON_div_sel,
                                          by = c("Site", "plotID")
)
...
## combine spectral and trait diversity metrics
trait_spec_NEON_table_MET_SAM_q1 <- full_join(trait_NEON_table_q1_sel,
                                          spec_NEON_div_sel,
                                          by = c("Site", "plotID")
)
...
## combine spectral and trait diversity metrics
trait_spec_NEON_table_MET_SAM_q2 <- full_join(trait_NEON_table_q2_sel,
                                          spec_NEON_div_sel,
                                          by = c("Site", "plotID")
)
...
## combine spectral and trait diversity metrics
trait_spec_NEON_table_MET_SAM_q3 <- full_join(trait_NEON_table_q3_sel,
                                          spec_NEON_div_sel,
                                          by = c("Site", "plotID")
)
...
save(trait_spec_NEON_table_MET_SAM_q0, trait_spec_NEON_table_MET_SAM_q1,
     trait_spec_NEON_table_MET_SAM_q2, trait_spec_NEON_table_MET_SAM_q3,
     file = "Results/RegDATA/trait_spec_MET_SAM_NEON.RData"
)
...
## combine spectral and trait diversity metrics
trait_spec_NEON_table_SAM_q0 <- full_join(trait_NEON_dis_table_q0_sel,
                                      spec_NEON_div_sel,
                                      by = c("Site", "plotID")
)
...
## combine spectral and trait diversity metrics
trait_spec_NEON_table_SAM_q1 <- full_join(trait_NEON_dis_table_q1_sel,
                                      spec_NEON_div_sel,
                                      by = c("Site", "plotID")
)
...
## combine spectral and trait diversity metrics
trait_spec_NEON_table_SAM_q2 <- full_join(trait_NEON_dis_table_q2_sel,
                                      spec_NEON_div_sel,
                                      by = c("Site", "plotID")
)
...
## combine spectral and trait diversity metrics
trait_spec_NEON_table_SAM_q3 <- full_join(trait_NEON_dis_table_q3_sel,
                                      spec_NEON_div_sel,
                                      by = c("Site", "plotID")
)
...
save(trait_spec_NEON_table_SAM_q0, trait_spec_NEON_table_SAM_q1,
     trait_spec_NEON_table_SAM_q2, trait_spec_NEON_table_SAM_q3,
     file = "Results/RegDATA/SAM/trait_spec_DIS_SAM_NEON.RData"
)
