...
names(spec_NEON_div_sel) <- c("Site", "plotID", "SD", "SD2", "MSD", "MSD2", 
...
names(phylo_NEON_table_q0_sel) <- c("Site", "plotID", "PD", "PDz", "MPD", "MPDz", 
...
names(phylo_NEON_table_q1_sel) <- c("Site", "plotID", "PD", "PDz", "MPD", "MPDz", 
                                    "M_p", "mPrime_p", "qHt_p", "qEt_p", "qDT_p", "qDTM_p")
...
names(phylo_NEON_table_q2_sel) <- c("Site", "plotID", "PD", "PDz", "MPD", "MPDz", 
                                    "M_p", "mPrime_p", "qHt_p", "qEt_p", "qDT_p", "qDTM_p")
...
names(phylo_NEON_table_q3_sel) <- c("Site", "plotID", "PD", "PDz", "MPD", "MPDz", 
                                    "M_p", "mPrime_p", "qHt_p", "qEt_p", "qDT_p", "qDTM_p")
...
tbl_moments_NEON <- list(taxoSpec = momentTaxoSpec_table, 
...
names(spec_NEON_div_sel) <- c("Site", "plotID", "MSD", "MSD2", "MSm", 
                              "M_s", "mPrime_s", "qHt_s", "qEt_s", "qDT_s", "qDTM_s")
...
names(trait_NEON_dis_table_q0_sel) <- c("Site", "plotID", "MFD", "MFDz",  "SR", "M_f", 
...
names(trait_NEON_dis_table_q1_sel) <- c("Site", "plotID", "MFD", "MFDz",  "SR", "M_f", 
                                        "mPrime_f", "qHt_f", "qEt_f", "qDT_f", "qDTM_f")
...
names(trait_NEON_dis_table_q2_sel) <- c("Site", "plotID", "MFD", "MFDz",  "SR", "M_f", 
                                        "mPrime_f", "qHt_f", "qEt_f", "qDT_f", "qDTM_f")
...
names(trait_NEON_dis_table_q3_sel) <- c("Site", "plotID", "MFD", "MFDz",  "SR", "M_f", 
                                        "mPrime_f", "qHt_f", "qEt_f", "qDT_f", "qDTM_f")
...
names(spec_NEON_div_sel) <- c("Site", "plotID", "MSm", "Divergence_s", 
...
names(trait_NEON_table_q0_sel) <- c("Site", "plotID", "Richness_t", "Divergence_t", 
...
names(trait_NEON_table_q1_sel) <- c("Site", "plotID", "Richness_t", "Divergence_t", 
                                    "Evenness_t", "Dispersion_t", "Rao_t")
...
names(trait_NEON_table_q2_sel) <- c("Site", "plotID", "Richness_t", "Divergence_t", 
                                    "Evenness_t", "Dispersion_t", "Rao_t")
...
names(trait_NEON_table_q3_sel) <- c("Site", "plotID", "Richness_t", "Divergence_t", 
                                    "Evenness_t", "Dispersion_t", "Rao_t")
